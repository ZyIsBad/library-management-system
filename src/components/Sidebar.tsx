    ...
    >
      <div className="flex items-start justify-between gap-4 p-5 sm:p-6 lg:block lg:p-8 lg:pt-10 lg:pb-6" id="sidebar-header">
        ...
        <button
          ...
          className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-slate-500 transition-colors hover:bg-[#EAE2D8] hover:text-[#712A2A] lg:hidden"
          onClick={onClose}
        >
          <X size={22} />
        </button>
