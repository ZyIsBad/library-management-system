...
const AddMemberModal: React.FC<AddMemberModalProps> = ({ isOpen, onClose, onAdd }) => {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 overflow-y-auto pt-20 px-4" id="modal-overlay">
            <motion.div
              ...
              id="modal-content"
            >
              <div className="p-8 border-b border-slate-100 flex justify-between items-center" id="modal-header">
                <div>
              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-6" id="add-member-form">
